...
import 'package:whois/presentation/screens/InfoScreens/mac_info.dart';

import 'package:whois/presentation/widgets/input_feld.dart';

class MacScan extends StatelessWidget {
  MacScan({Key? key}) : super(key: key);
  final controller = TextEditingController();
  @override
  Widget build(BuildContext context) {
    return BlocConsumer<MacCubit, MacState>(listener: (context, state) {
      if (state is MacError) {
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          BlocProvider.of<MacCubit>(context)
                              .getMacInfo(controller.text);
                        },
